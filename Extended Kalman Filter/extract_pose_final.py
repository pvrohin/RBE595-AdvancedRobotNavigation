...
def main():
    ...
    for i in range(8):
        ...
        # Plot the estimated and ground truth orientations
        fig, ax = plt.subplots(3, 1, figsize=(10, 10))
        ax[0].plot(estimated_orientations[:, 0], label='Estimated')
        ax[0].plot(ground_truth_orientations[:, 0], label='Ground Truth')
        ax[0].set_xlabel('Time')
        ax[0].set_ylabel('Roll')
        ax[0].set_title('Estimated vs. Ground Truth Roll')
        ax[0].legend()
        ax[1].plot(estimated_orientations[:, 1], label='Estimated')
        ax[1].plot(ground_truth_orientations[:, 1], label='Ground Truth')
        ax[1].set_xlabel('Time')
        ax[1].set_ylabel('Pitch')
        ax[1].set_title('Estimated vs. Ground Truth Pitch')
        ax[1].legend()
        ax[2].plot(estimated_orientations[:, 2], label='Estimated')
        ax[2].plot(ground_truth_orientations[:, 2], label='Ground Truth')
        ax[2].set_xlabel('Time')
        ax[2].set_ylabel('Yaw')
        ax[2].set_title('Estimated vs. Ground Truth Yaw')
        ax[2].legend()
